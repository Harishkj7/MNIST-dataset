...
trainDigits <- read.csv("/Users/Harish7KJ/Desktop/cs-513Project/knn/data/mnist_train.csv")
testDigits <- read.csv("/Users/Harish7KJ/Desktop/cs-513Project/knn/data/mnist_test.csv")
trainFeatures <- trainDigits[1:6000,2:785]
trainLabels <- trainDigits[1:6000,1]
predFeatures <- read.csv("/Users/Harish7KJ/Desktop/cs-513Project/knn/data/mnist_test.csv")
