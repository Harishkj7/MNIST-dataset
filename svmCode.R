...
load_mnist <- function() {
  ...
  train <<- load_image_file('/Users/Harish7KJ/Desktop/cs-513Project/dataset/train-images.idx3-ubyte')
  test <<- load_image_file('/Users/Harish7KJ/Desktop/cs-513Project/dataset/t10k-images.idx3-ubyte')
  
  train$y <<- load_label_file('/Users/Harish7KJ/Desktop/cs-513Project/dataset/train-labels.idx1-ubyte')
  test$y <<- load_label_file('/Users/Harish7KJ/Desktop/cs-513Project/dataset/t10k-labels.idx1-ubyte')
}
